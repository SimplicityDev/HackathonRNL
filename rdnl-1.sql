...
--
-- Host: 127.0.0.1
-- Gegenereerd op: 06 okt 2017 om 15:28
-- Serverversie: 5.7.14
-- PHP-versie: 5.6.25
...
INSERT INTO `organisation` (`Id`, `Title`, `Adress`, `Phone`, `Website`, `Email`) VALUES
(1, 'Sint-Michielsgestel', 'Meanderplein 1, 5271 GC Sint-Michielsgestel', '0735531111', 'https://www.sint-michielsgestel.nl', 'gemeente@sint-michielsgestel.nl');
...
--
-- Gegevens worden geëxporteerd voor tabel `request_has_steps`
--

INSERT INTO `request_has_steps` (`Request_id`, `Steps_Id`) VALUES
(1, 1),
(1, 2),
(1, 3),
(1, 4),
...
CREATE TABLE `steps` (
  ...
  `Title` varchar(70) DEFAULT NULL,
  `Desc` text,
  `Time` int(11) NOT NULL COMMENT 'in months'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `steps` (`Id`, `Title`, `Desc`, `Time`) VALUES
(1, 'De aanvraag is ingediend', 'De aanvraag is succesvol ingediend', 0),
(2, 'Informatie controleren', 'De informatie wordt op dit moment gecontroleerd door de gemeente <?php echo $gemeente;?> en kijkt of je aanvraag in het straatbeeld past.', 1),
(3, 'Bezwaar termijn', 'Tijdens deze 6 weken tijd kan er door de belanghebbende bezwaar aangetekend worden.', 6),
(4, 'Bezwaar controleren', 'De gemeente <?php echo $gemeente;?> kijkt of het bezwaar terecht is.', 2),
(5, 'Bezwaar antwoorden', 'Als er serieus bezwaar is aangetekend is kan je dit aanvechten, ook kan je je aanvraag aanpassen.', 2),
(6, 'Vergunning', 'Als er geen bezwaar meer is heb je je vergunning', 0),
(7, 'Controle van wetgeving', 'De gemeente <?php echo $gemeente;?> kijkt of de wetgeving wordt nageleefd.', 1),
(8, 'Eventuele informatie bijvullen', 'Als blijkt dat je niet alle (juiste) data hebt aangeleverd is dit het moment dat je de extra gegevens aanleverd.', 2);
...
--
-- Gegevens worden geëxporteerd voor tabel `steps_has_organisation`
--

INSERT INTO `steps_has_organisation` (`Steps_Id`, `Organisation_Id`) VALUES
(2, 1),
(4, 1),
(7, 1);
