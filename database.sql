...
CREATE TABLE IF NOT EXISTS `rdnl`.`Solutions` (
  ...
  PRIMARY KEY (`Id`),
  INDEX `fk_Solutions_Request1_idx` (`Request_Id` ASC),
  CONSTRAINT `fk_Solutions_Request1`
...
CREATE TABLE IF NOT EXISTS `rdnl`.`Person_has_Request` (
  ...
  CONSTRAINT `fk_Person_has_Request_Request1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Person_has_Request_Steps1`
    FOREIGN KEY (`Steps_Id`)
    REFERENCES `rdnl`.`Steps` (`Id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
